...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-reportes-consulta-key-change-in-production')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,reportes-consulta,.onrender.com,*').split(',')
...
# CORS Configuration
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,https://sportcare-frontend.onrender.com').split(',')
CORS_ALLOW_ALL_ORIGINS = os.environ.get('CORS_ALLOW_ALL_ORIGINS', 'True') == 'True'

# API Configuration - URLs dinámicas basadas en entorno
BACKEND_HOST = os.environ.get('BACKEND_HOST', 'sportcare-backend.onrender.com')
BACKEND_PORT = os.environ.get('BACKEND_PORT', '443')
